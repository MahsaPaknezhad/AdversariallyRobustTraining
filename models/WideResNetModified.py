...
class WideBasic(nn.Module):
    def __init__(self, activation, in_planes, planes, dropout_rate, stride=1):
...
class WideResNetModified(nn.Module):
    def __init__(self, activation, depth, widen_factor, dropout_rate, num_classes):
    ...
    def _wide_layer(self, block, planes, num_blocks, dropout_rate, stride):
        ...
        for stride in strides:
            layers.append(block(self.activation, self.in_planes, planes, dropout_rate, stride))
